...
<body>
    ...
    <div class="container ">
        <nav class="navbar navbar-default" style="background-image: url('../assets/bg.png'); margin: 0px;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Workout Databases</a>
                </div>
        ...
        <div class="content" >
                ...
                <li class="list-group-item "><a href="index.php?mod=workout"> <i class="fa fa-search "></i> <span class="hidden-xs">Workout List</span></a></li>
                </ul>
